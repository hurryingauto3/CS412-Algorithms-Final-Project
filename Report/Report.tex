...
\subsubsection {Nearest Neighbour Algorithm}
        ...
        2.  Whenever you reach any vertex, look at the weights of all the edges that lead to vertices you haven’t visited yet. Choose the one that has the least weight. \newline
        3.  Repeat step 2 until you’ve reached the last vertex. Else go back to the starting point. \newline \newline
